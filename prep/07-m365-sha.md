...
| [MS-4019 エージェントを使用して日常のビジネス プロセスを変革する](https://school.ctc-g.co.jp/course/P814.html) |
| [PL-7008：PL-7008 Microsoft Copilot Studio でエージェントを作成する](https://school.ctc-g.co.jp/course/P914.html) |
...
1. **Microsoft365 Portal 接続確認手順（※重要※)**
   ...
   c.サインイン画面が表示されます。受講案内 (件名が「【CTC教育サービス】コース受講のご案内」から始まるメール) にてお知らせした確認用アカウントにてサインインを行います。
