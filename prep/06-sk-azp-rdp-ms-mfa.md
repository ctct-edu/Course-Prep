...
5. **Microsoft Authenticator** **インストール手順**
   ...
   ![mfa1](C:/Users/otokita/Documents/course-prep/icon/mfa1.png)　

   

   b.ストア画面が表示されましたら、インストールをしてください。

   ![mfa2](C:/Users/otokita/Documents/course-prep/icon/mfa2.png)　

   

   c.インストール後にアプリを起動してください。起動後に初期設定を行います。

   ![mfa3](C:/Users/otokita/Documents/course-prep/icon/mfa3.png)　
   ...
   ![mfa4](C:/Users/otokita/Documents/course-prep/icon/mfa4.png)　
